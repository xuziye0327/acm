### 题目链接
<a href="http://acm.hdu.edu.cn/showproblem.php?pid=3400">HERE</a>

### 题目描述
有AB和CD两条线段，lxhgww在AB线段上速度为p，在CD上为q，其它地方为r。
问lxhgww从A到D所需要花费的最小时间。

### 解题思路
两次三分，分别三分AB上的点和CD上的点。
终止条件应该是mid和midmid的坐标一样。
一开始想的结束条件是按点的x坐标为终止条件，结果老半天才反应过来，真是脑抽了。
